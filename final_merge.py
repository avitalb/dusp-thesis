...
if __name__ == '__main__':
    ...
    final_merge("results/2019_cash_merged_geocoded.csv","results/2019_cash_ethnicity.csv","results/2019_cash_all_cols")
    final_merge("results/2017_cash_merged_geocoded.csv","results/2017_cash_ethnicity.csv","results/2017_cash_all_cols")
